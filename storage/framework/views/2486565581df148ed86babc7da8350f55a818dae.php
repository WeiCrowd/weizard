                                ...
                                <table id="dataTableExample2" class="table table-bordered table-striped table-hover dataTableExample2">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo e(url("admin/icocategory/$id/edit")); ?>"><button type="button" class="btn btn-primary btn-circle m-b-5"  title="<?php echo e(Lang::get('common.Edit')); ?>" ><i class="glyphicon glyphicon-edit"></i></button></a></td>
                                        </tr>
                                        <?php $i++; ?>
