            ...
            <tbody>
                                ...
                                <tr>
                                    <td style="padding:10px 0">
                                        ...
                                        <p style="font-size:13px;line-height:22px;color:#606060; font-family: 'Montserrat', sans-serif;margin:0;padding:0;display:block;margin-top:30px;">
                                            ...
                                            <strong style="display:table">Team WeiCrowd</strong>
                                            <strong style="display:table">The Safest Token Marketplace</strong>
                                            <strong style="display:table"><a href="https://www.weicrowd.com/" target="_blank">WeiCrowd.com</a> | <a href="https://www.weix.io/" target="_blank">Weix.io</a></strong>
                                        </p>
                ...
                <tr>
                    <td style="padding:5px 70px 0px">
                        ...
                        <p style="font-size:14px;color:#9a9a9a;line-height:22px;text-align:center;margin-bottom:15px;font-family: 'Montserrat', sans-serif;">
                            WeiCrowd Pte Ltd., Singapore &copy; 2018. All Right Reserved
                        </p>
