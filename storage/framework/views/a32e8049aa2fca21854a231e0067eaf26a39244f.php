<header class="main-header">
    <a href="<?php echo e(route('dashboard')); ?>" class="logo">
        <span class="logo-mini">
            <!--<b>A</b>BD-->
            <img src="<?php echo e(asset('content/images/weizard_white.svg')); ?>" alt="">
        </span>
        <span class="logo-lg">
            <!--<b>Admin</b>BD-->
            <img src="<?php echo e(asset('content/images/weizard_white.svg')); ?>" alt="">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <ul class="menu">
                                <li> start message 
                                    <a href="#">
                                        <div class="pull-left"><img src="<?php echo e(asset('assets/dist/img/avatar.png')); ?>" class="img-circle" alt="User Image"></div>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left"><img src="<?php echo e(asset('assets/dist/img/avatar2.png')); ?>" class="img-circle" alt="User Image"></div>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left"><img src="<?php echo e(asset('assets/dist/img/avatar3.png')); ?>" class="img-circle" alt="User Image"></div>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left"><img src="<?php echo e(asset('assets/dist/img/avatar4.png')); ?>" class="img-circle" alt="User Image"></div>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left"><img src="<?php echo e(asset('assets/dist/img/avatar5.png')); ?>" class="img-circle" alt="User Image"></div>
...
<!--                <li class="dropdown dropdown-user">
                    <a href="<?php echo e(url('/logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" title="Logout"><i class="fa fa-sign-out" aria-hidden="true"></i></a>
                ...
                <li class="dropdown dropdown-user">
                    ...
                    <ul class="dropdown-menu">
<!--                        <li><a href="<?php echo e(route('admin_profile')); ?>"><i class="pe-7s-users"></i>User Profile</a></li>
                        <li><a href="<?php echo e(route('admin_site_setting')); ?>"><i class="pe-7s-settings"></i>Site Settings</a></li>-->
                        <li>
