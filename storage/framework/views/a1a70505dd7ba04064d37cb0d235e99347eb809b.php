            ...
            <div class="tab-content">
                <div class="tab-pane fade in active" id="tab1">
                    <div class="panel-body">
                       <div class="row">
                                ...
                                <table id="dataTableExample2" class="table table-bordered table-striped table-hover dataTableExample2">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e(ucwords($value['ico_type'] == 'I'?"ICO":"Pre ICO")); ?></td>
                        ...
                        <?php echo e(Form::button('Active All', array('type'=>'button', 'class'=>'btn btn-primary w-md m-b-5', 'title' => Lang::get("admin/user/ico.Active"),'data-link'=>url("admin/active-ico"), 'id' =>'active-multiple-ico'))); ?>
                ...
                <div class="tab-pane fade" id="tab2">
                    <div class="panel-body">
                        ...
                        <?php echo e(Form::button('Inactive All', array('type'=>'button', 'class'=>'btn btn-primary w-md m-b-5', 'title' => Lang::get("admin/user/ico.Inactive"),'data-link'=>url("admin/inactive-ico"), 'id' =>'inactive-multiple-ico'))); ?>
