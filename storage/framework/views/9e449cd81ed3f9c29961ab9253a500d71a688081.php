<?php $__env->startSection('content'); ?>
 <!-- Dashboard Content -->
        ...
        <div class="panel marAuto">
           ...
           <?php echo e(Form::open(['method' => 'POST','class'=>'panel-main form panel-form has-left-labels','id'=>'validateTeamForm','autocomplete'=>'off', 'url'=> route('save_ico'), 'enctype' => 'multipart/form-data'])); ?>
                ...
                <div class="form-group-wrap team-information-wrap">
                    ...
                    <div class="form-group row">
                        <div class="col-md-4 col-sm-5">
                            <label class="form-group-label"><?php echo e(Lang::get('startup/ico.member_name')); ?><span class="required">*</span>:</label>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group row">
                        <div class="col-md-4 col-sm-5">
                            <label class="form-group-label"><?php echo e(Lang::get('startup/ico.member_designation')); ?><span class="required">*</span>:</label>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group row">
                        <div class="col-md-4 col-sm-5">
                            <label class="form-group-label"><?php echo e(Lang::get('startup/ico.linkedin_url')); ?>:</label>
                        </div>
                        <div class="col-sm-6">
                           <?php echo e(Form::text('linkedin_url[]',@$teamVal['linkedin_url'], ['class' => 'form-control','placeholder'=>Lang::get('startup/ico.linkedin_url'),'id'=>'linkedin_url'])); ?>

                            <span class="text-danger"><?php echo e($errors->first('linkedin_url')); ?></span>
                        </div>
                    </div>
                    <!-- Form Group -->
