                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="site-banner-text full-max-width text-center">
                                ...
                                <a href="<?php echo e(url('/register')); ?>" class="primary-btn theme2-btn highlight-btn">CREATE CAMPAIGN</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <ul class="listing-items has-five-items">
                            ...
                            <?php $__currentLoopData = @$icoData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $icoVal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="listing-box">
                                    <a href="#">
                                        <div class="listing-box-figure"><img src="<?php echo e(url('/')); ?>/ICO/LogoImage/<?php echo e($icoVal->logo_image); ?>" alt="Image" width="50px" /></div>
                                        <h6 class="listing-box-heading"><?php echo e($icoVal->name); ?> by Weis</h6>
...
<!--                            <li class="listing-box">
                                <a href="coin-page.html">
                                    <div class="listing-box-figure"><img src="<?php echo e(asset('content/images/listing-figure-placeholder.png')); ?>" alt="Image" /></div>
