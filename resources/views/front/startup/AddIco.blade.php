    ...
    <div class="panel marAuto">
        <div class="panel-aside">
            ...
            <div class="panel-aside-center panel-aside-item">
                <div class="panel-aside-icon"><img src="{{ asset('content/images/panel-info-icon.svg') }}" alt="Info" /></div>
...
<!--validateIcoForm-->
        {{ Form::open(['method' => 'POST','class'=>'panel-main form panel-form has-left-labels','id'=>'validateIcoForm','autocomplete'=>'off', 'url'=> route('social_information'), 'enctype' => 'multipart/form-data']) }}
        ...
        <div class="form-group-wrap">
            ...
            <div class="form-group row">
                <div class="col-md-4 col-sm-4">
                    <label class="form-group-label">{{ Lang::get('startup/ico.ico_category') }}<span class="required">*</span>:</label>
                </div>
                <div class="col-md-6 col-sm-6">
                    {{ Form::select('category_id', [''=>'Please Select Category']+@$category, @$edit_ico->category_id, ['class' => 'form-control','id'=>'category_id']) }}
            ...
            <div class="form-group row">
                <div class="col-md-4 col-sm-4">
                    <label class="form-group-label">{{ Lang::get('startup/ico.ico_name') }}<span class="required">*</span>:</label>
                </div>
                <div class="col-md-6 col-sm-6">
            ...
            <div class="form-group row" id="symbol_div">
                <div class="col-md-4 col-sm-4">
                    <label class="form-group-label">{{ Lang::get('startup/ico.symbol') }}<span class="required">*</span>:</label>
                </div>
                <div class="col-md-6 col-sm-6">
                    {{ Form::hidden('hiddenSymbol', @$edit_ico->symbol, ['id'=>'hiddenSymbol']) }}
            ...
            <div class="form-group row">
                <div class="col-md-4 col-sm-4">
                    <label class="form-group-label">{{ Lang::get('startup/ico.token_price') }}<span class="required">*</span>:</label>
                </div>
                <div class="col-md-6 col-sm-6">
            ...
            <div class="form-group row">
                <div class="col-md-4 col-sm-4">
                    <label class="form-group-label">{{ Lang::get('startup/ico.whitelist') }}<span class="required">*</span>:</label>
                </div>
                <div class="col-md-6 col-sm-6">
            ...
            <div class="form-group row">
                <div class="col-md-4 col-sm-4">
                    <label class="form-group-label">{{ Lang::get('startup/ico.kyc') }}<span class="required">*</span>:</label>
                </div>
                <div class="col-md-6 col-sm-6">
            ...
            <div class="form-group row">
                <div class="col-md-4 col-sm-4">
                    <label class="form-group-label">{{ Lang::get('startup/ico.start_time') }}<span class="required">*</span>:</label>
                </div>
                <div class="col-sm-6">
                    {{ Form::text('start_time',  @$edit_ico->start_time?@date("d/m/Y H:i:s",strtotime($edit_ico->start_time)):'', ['class' => 'form-control form_datetime','placeholder'=>Lang::get('startup/ico.start_time'),'readonly'=>'true', 'data-date-format' =>'dd/mm/yyyy hh:ii:ss']) }}
            ...
            <div class="form-group row">
                <div class="col-md-4 col-sm-4">
                    <label class="form-group-label">{{ Lang::get('startup/ico.end_time') }}<span class="required">*</span>:</label>
                </div>
                <div class="col-sm-6">
                    {{ Form::text('end_time',  @$edit_ico->end_time?@date("d/m/Y H:i:s",strtotime(@$edit_ico->end_time)):'', ['class' => 'form-control form_datetime','placeholder'=>Lang::get('startup/ico.end_time'),'readonly'=>'true', 'data-date-format' =>'dd/mm/yyyy hh:ii:ss']) }}
            ...
            <div class="form-group row">
                <div class="col-md-4 col-sm-4">
                    <label class="form-group-label">{{ Lang::get('startup/ico.technology') }}<span class="required">*</span>:</label>
                </div>
                <div class="col-sm-6">
            ...
            <div class="form-group row">
                <div class="col-md-4 col-sm-4">
                    <label class="form-group-label">{{ Lang::get('startup/ico.soft_cap') }}<span class="required">*</span>:</label>
                </div>
                <div class="col-sm-6">
            ...
            <div class="form-group row">
                <div class="col-md-4 col-sm-4">
                    <label class="form-group-label">{{ Lang::get('startup/ico.hardcap') }}<span class="required">*</span>:</label>
                </div>
                <div class="col-sm-6">
            ...
            <div class="form-group row">
                <div class="col-md-4 col-sm-4">
                    <label class="form-group-label">{{ Lang::get('startup/ico.restriction') }}<span class="required">*</span>:</label>
                </div>
                <div class="col-sm-6">
            ...
            <div class="form-group row">
                <div class="col-md-4 col-sm-4">
                    <label class="form-group-label">{{ Lang::get('startup/ico.accepts') }}<span class="required">*</span>:</label>
                </div>
                <div class="col-sm-6">
            ...
            <div class="form-group row">
                <div class="col-md-4 col-sm-4">
                    <label class="form-group-label">{{ Lang::get('startup/ico.origin_country') }}<span class="required">*</span>:</label>
                </div>
                <div class="col-sm-6">
