    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Startup Registration</div>
                @if($errors->any())
                    <h5>{{$errors->first()}}</h5>
                @endif
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('startup_saveregister') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="checkbox" name="terms" required=""> I Agree for Terms and conditions
                            </div>
                        </div>
