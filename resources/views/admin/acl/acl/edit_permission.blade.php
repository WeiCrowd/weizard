...
@section('heading')
  {{ Lang::get('common.Manage') }} {{ Lang::get('admin/AccessManagement/permission.HEADING') }}
@endsection

@section('sub_heading')
  {{ Lang::get('admin/AccessManagement/permission.SUB_HEADING') }}
@endsection
...
<div class="grid">
    <div class="container-fluid">
        ...
        <div class="editpermission">
            ...
            'class' => 'form-signin',
            'url' => route('add_permission', $role->id)
            )
            )
            !!}
            ...
            @else
            @include('admin.acl.acl.partials.permissions-none')
            @endif
