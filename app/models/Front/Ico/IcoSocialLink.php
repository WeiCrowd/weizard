...
class IcoSocialLink extends Model {

    protected $table = 'ico_social_links';
   ...
   /**
    ...
    {
        $varData = self::orderBy('id', 'desc')->get();
        return ($varData ? : []);
    }
    ...
    public static function getAllDataByIcoId($id)
    {
         $data = self::where('ico_id',$id)
                      ->get();
    ...
    public static function deleteSocialLink($ico_id)
    {
